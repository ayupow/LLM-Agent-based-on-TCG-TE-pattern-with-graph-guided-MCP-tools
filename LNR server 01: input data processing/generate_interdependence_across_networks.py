...
def generate_interdependence_across_networks(input_file):
    ...
    return print("The path to interdependent infrastructure networks has been saved in Global_data.json")
...
generate_interdependence_across_networks("Global_Data.json")