...
def schedule_restoration_sequence_considering_population_by_GA(global_json_path):
    # Clean path
    ...
    output_json_path = 'recovery_sequence_considering_population_by_GA.json'
    with open(output_json_path, 'w') as f:
        json.dump(daily_recovery_order, f, indent=4)

    # Update global data output path
    global_data["recovery_sequence_considering_population_by_GA"] = output_json_path
