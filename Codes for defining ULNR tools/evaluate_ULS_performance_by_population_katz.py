...
def evaluate_ULS_performance_by_population_katz(global_json_path):
    """
    ...
    if not failed_nodes:
        ...
        output_json_path = 'evaluate_ULS_performance_by_population_katz.json'

        with open(output_json_path, 'w') as outfile:
            json.dump(result, outfile, indent=4)

        # Update the Global_Data.json file with the recovery strategy result path
        file_paths['evaluate_ULS_performance_by_population_katz'] = output_json_path
