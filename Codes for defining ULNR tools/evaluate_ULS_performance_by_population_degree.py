...
def evaluate_ULS_performance_by_population_degree(global_json_path):
    """
    ...
    output_json_path = 'evaluate_ULS_performance_by_population_degree.json'

    with open(output_json_path, 'w') as outfile:
        json.dump(result, outfile, indent=4)

    # Update the Global_Data.json file with the recovery strategy result path
    file_paths['evaluate_ULS_performance_by_population_degree'] = output_json_path
