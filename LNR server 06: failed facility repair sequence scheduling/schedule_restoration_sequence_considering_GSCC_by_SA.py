...
def schedule_restoration_sequence_considering_GSCC_by_SA(global_json_path):
    """
    ...
    output_json_path = 'recovery_sequence_considering_GSCC_by_SA.json'
    with open(output_json_path, 'w') as f:
        json.dump(recovery_order, f, indent=4)

    # Update global data
    global_data["recovery_sequence_considering_GSCC_by_SA"] = output_json_path
