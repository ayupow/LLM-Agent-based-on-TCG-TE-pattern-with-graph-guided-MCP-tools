...
model = ChatOpenAI(
    temperature=0.0,
    model_name="qwen-max-latest",               # <<— replace with the Bailian model name you subscribed to
...
Begin!""")
    ...
    for idx, task in enumerate(tasks, start=1):
        ...
        print(f"Task {idx} saved to MCP_agent_response_one_client_qwen-max-latest.xlsx")
