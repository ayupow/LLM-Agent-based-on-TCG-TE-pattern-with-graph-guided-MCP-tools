...
def evaluate_ULS_performance_by_node_reachability(global_json_path: str):
    ...
    output_json_path = 'evaluate_ULS_performance_by_node_reachability.json'
    ...
    file_paths['evaluate_ULS_performance_by_node_reachability'] = output_json_path
