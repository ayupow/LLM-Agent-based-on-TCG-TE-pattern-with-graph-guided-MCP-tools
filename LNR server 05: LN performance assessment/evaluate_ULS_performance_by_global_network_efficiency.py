...
def evaluate_ULS_performance_by_global_network_efficiency(global_json_path: str):
    ...
    output_json_path = 'evaluate_ULS_performance_by_global_efficiency.json'
    ...
    file_paths['evaluate_ULS_performance_by_global_efficiency'] = output_json_path
