...
def evaluate_ULS_performance_by_population_betweenness(global_json_path):
    """
    ...
    output_json_path = 'evaluate_ULS_performance_by_population_betweenness.json'
    ...
    file_paths['evaluate_ULS_performance_by_population_betweenness'] = output_json_path
