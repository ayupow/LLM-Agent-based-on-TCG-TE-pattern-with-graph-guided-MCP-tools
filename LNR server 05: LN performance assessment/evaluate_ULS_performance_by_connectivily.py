...
def evaluate_ULS_performance_by_connectivily(global_json_path: str):
    ...
    output_json_path = 'evaluate_ULS_performance_by_connectivity.json'
    ...
    file_paths['evaluate_ULS_performance_by_connectivity'] = output_json_path
