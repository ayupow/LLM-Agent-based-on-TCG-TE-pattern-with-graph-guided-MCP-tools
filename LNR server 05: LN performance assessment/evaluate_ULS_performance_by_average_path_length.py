...
def evaluate_ULS_performance_by_average_path_length(global_json_path: str):
    ...
    output_json_path = 'evaluate_ULS_performance_by_average_path_length.json'
    ...
    file_paths['evaluate_ULS_performance_by_average_path_length'] = output_json_path
