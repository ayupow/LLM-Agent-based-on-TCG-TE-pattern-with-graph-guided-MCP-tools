...
async def main():
    ...
    print("=" * 60)
    print("Step 2: Connecting to MCP servers (L7: 18 servers, 209 tools) ...")
    client = MultiServerMCPClient(
        {
            ...
            "added_gis_data_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_data_L7.py"]
            },
            "added_gis_geopandas_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_geopandas_L7.py"]
            },
            "added_gis_pyproj_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_pyproj_L7.py"]
            },
            "added_gis_pysal_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_pysal_L7.py"]
            },
            "added_gis_rasterio_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_rasterio_L7.py"]
            },
            "added_gis_shapely_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_shapely_L7.py"]
            },
            "added_gis_utilities_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_utilities_L7.py"]
            },
            "added_gis_visualize_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_visualize_L7.py"]
            },
            "added_math_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_math_L7.py"]
            },
            "added_networkx_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_networkx_L7.py"]
            },
            "added_powerfactory_L7": {
                "command": "python", "transport": "stdio",
                "args": ["added_powerfactory_L7.py"]
            },
        }
    )
    ...
    output_path = "MCP_agent_response_L7_209tools_fused.xlsx"
