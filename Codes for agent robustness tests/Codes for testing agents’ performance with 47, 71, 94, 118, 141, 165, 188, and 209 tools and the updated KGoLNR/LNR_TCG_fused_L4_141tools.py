...
async def main():
    ...
    print("=" * 60)
    print("Step 2: Connecting to MCP servers (L4: 18 servers, 141 tools) ...")
    client = MultiServerMCPClient(
        {
            ...
            "added_gis_data_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_data_L4.py"]
            },
            "added_gis_geopandas_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_geopandas_L4.py"]
            },
            "added_gis_pyproj_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_pyproj_L4.py"]
            },
            "added_gis_pysal_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_pysal_L4.py"]
            },
            "added_gis_rasterio_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_rasterio_L4.py"]
            },
            "added_gis_shapely_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_shapely_L4.py"]
            },
            "added_gis_utilities_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_utilities_L4.py"]
            },
            "added_gis_visualize_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_gis_visualize_L4.py"]
            },
            "added_math_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_math_L4.py"]
            },
            "added_networkx_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_networkx_L4.py"]
            },
            "added_powerfactory_L4": {
                "command": "python", "transport": "stdio",
                "args": ["added_powerfactory_L4.py"]
            },
        }
    )
    ...
    output_path = "MCP_agent_response_L4_141tools_fused.xlsx"
