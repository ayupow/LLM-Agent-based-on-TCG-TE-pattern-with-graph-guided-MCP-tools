...
api_key = "sk-hCtJSH4WFbzbsuHnzNI4iVS8srJQIYEyg0qGfbPn8DdS9BKl"
...
async def main():
    updated_kg = auto_update_knowledge_graph(output_file='KGoLNR_updated_L3.json')
    print("="*60)
    ...
    print("="*60)
    print("Step 2: Connecting MCP servers (L3: 17 servers, 118 tools)...")
    client = MultiServerMCPClient({
        ...
        "added_gis_data_L3": {"command": "python", "transport": "stdio", "args": ["added_gis_data_L3.py"]},
        "added_gis_geopandas_L3": {"command": "python", "transport": "stdio", "args": ["added_gis_geopandas_L3.py"]},
        "added_gis_pysal_L3": {"command": "python", "transport": "stdio", "args": ["added_gis_pysal_L3.py"]},
        "added_gis_rasterio_L3": {"command": "python", "transport": "stdio", "args": ["added_gis_rasterio_L3.py"]},
        "added_gis_shapely_L3": {"command": "python", "transport": "stdio", "args": ["added_gis_shapely_L3.py"]},
        "added_gis_utilities_L3": {"command": "python", "transport": "stdio", "args": ["added_gis_utilities_L3.py"]},
        "added_gis_visualize_L3": {"command": "python", "transport": "stdio", "args": ["added_gis_visualize_L3.py"]},
        "added_math_L3": {"command": "python", "transport": "stdio", "args": ["added_math_L3.py"]},
        "added_networkx_L3": {"command": "python", "transport": "stdio", "args": ["added_networkx_L3.py"]},
        "added_powerfactory_L3": {"command": "python", "transport": "stdio", "args": ["added_powerfactory_L3.py"]},
    })
    ...
    output_path = "MCP_agent_response_L3_118tools_autoupdate.xlsx"
