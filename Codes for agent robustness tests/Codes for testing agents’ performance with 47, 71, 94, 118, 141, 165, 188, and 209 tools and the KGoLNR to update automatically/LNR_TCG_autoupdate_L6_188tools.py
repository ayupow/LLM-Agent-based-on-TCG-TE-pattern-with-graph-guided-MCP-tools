...
async def main():
    updated_kg = auto_update_knowledge_graph(output_file='KGoLNR_updated_L6.json')
    ...
    client = MultiServerMCPClient({
        ...
        "added_gis_data_L6": {"command":"python","transport":"stdio","args":["added_gis_data_L6.py"]},
        "added_gis_geopandas_L6": {"command":"python","transport":"stdio","args":["added_gis_geopandas_L6.py"]},
        "added_gis_pyproj_L6": {"command":"python","transport":"stdio","args":["added_gis_pyproj_L6.py"]},
        "added_gis_pysal_L6": {"command":"python","transport":"stdio","args":["added_gis_pysal_L6.py"]},
        "added_gis_rasterio_L6": {"command":"python","transport":"stdio","args":["added_gis_rasterio_L6.py"]},
        "added_gis_shapely_L6": {"command":"python","transport":"stdio","args":["added_gis_shapely_L6.py"]},
        "added_gis_utilities_L6": {"command":"python","transport":"stdio","args":["added_gis_utilities_L6.py"]},
        "added_gis_visualize_L6": {"command":"python","transport":"stdio","args":["added_gis_visualize_L6.py"]},
        "added_math_L6": {"command":"python","transport":"stdio","args":["added_math_L6.py"]},
        "added_networkx_L6": {"command":"python","transport":"stdio","args":["added_networkx_L6.py"]},
        "added_powerfactory_L6": {"command":"python","transport":"stdio","args":["added_powerfactory_L6.py"]},
    })
    ...
    output_path = "MCP_agent_response_L6_188tools_autoupdate.xlsx"
