...
"""
    ...
    try:
        ...
        print(f"  [WARN] JSON parse failed. Response: {llm_response[:300]}...")
        new_entries = []
    added = 0
...
async def main():
    updated_kg = auto_update_knowledge_graph(output_file='KGoLNR_updated_L2.json')
    print("="*60)
    ...
    print("="*60)
    print("Step 2: Connecting MCP servers (L2: 15 servers, 94 tools)...")
    client = MultiServerMCPClient({
        ...
        "added_gis_data_L2": {"command": "python", "transport": "stdio", "args": ["added_gis_data_L2.py"]},
        "added_gis_geopandas_L2": {"command": "python", "transport": "stdio", "args": ["added_gis_geopandas_L2.py"]},
        "added_gis_pyproj_L2": {"command": "python", "transport": "stdio", "args": ["added_gis_pyproj_L2.py"]},
        "added_gis_pysal_L2": {"command": "python", "transport": "stdio", "args": ["added_gis_pysal_L2.py"]},
        "added_gis_utilities_L2": {"command": "python", "transport": "stdio", "args": ["added_gis_utilities_L2.py"]},
        "added_gis_visualize_L2": {"command": "python", "transport": "stdio", "args": ["added_gis_visualize_L2.py"]},
        "added_math_L2": {"command": "python", "transport": "stdio", "args": ["added_math_L2.py"]},
        "added_powerfactory_L2": {"command": "python", "transport": "stdio", "args": ["added_powerfactory_L2.py"]},
    })
    ...
    output_path = "MCP_agent_response_L2_94tools_autoupdate.xlsx"
