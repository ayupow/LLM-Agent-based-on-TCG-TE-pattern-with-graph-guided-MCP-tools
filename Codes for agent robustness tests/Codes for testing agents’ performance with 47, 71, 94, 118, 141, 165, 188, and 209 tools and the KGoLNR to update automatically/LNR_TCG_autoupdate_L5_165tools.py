...
model = ChatOpenAI(model_name="claude-sonnet-4-20250514-s", openai_api_key=api_key, openai_api_base=URL)
...
""")
    ...
    try:
        ...
        print("  [WARN] JSON parse failed."); new_entries = []
    added = 0
...
async def main():
    updated_kg = auto_update_knowledge_graph(output_file='KGoLNR_updated_L5.json')
    ...
    client = MultiServerMCPClient({
        ...
        "added_gis_data_L5": {"command":"python","transport":"stdio","args":["added_gis_data_L5.py"]},
        "added_gis_geopandas_L5": {"command":"python","transport":"stdio","args":["added_gis_geopandas_L5.py"]},
        "added_gis_pyproj_L5": {"command":"python","transport":"stdio","args":["added_gis_pyproj_L5.py"]},
        "added_gis_pysal_L5": {"command":"python","transport":"stdio","args":["added_gis_pysal_L5.py"]},
        "added_gis_rasterio_L5": {"command":"python","transport":"stdio","args":["added_gis_rasterio_L5.py"]},
        "added_gis_shapely_L5": {"command":"python","transport":"stdio","args":["added_gis_shapely_L5.py"]},
        "added_gis_utilities_L5": {"command":"python","transport":"stdio","args":["added_gis_utilities_L5.py"]},
        "added_gis_visualize_L5": {"command":"python","transport":"stdio","args":["added_gis_visualize_L5.py"]},
        "added_math_L5": {"command":"python","transport":"stdio","args":["added_math_L5.py"]},
        "added_networkx_L5": {"command":"python","transport":"stdio","args":["added_networkx_L5.py"]},
        "added_powerfactory_L5": {"command":"python","transport":"stdio","args":["added_powerfactory_L5.py"]},
    })
    ...
    output_path = "MCP_agent_response_L5_165tools_autoupdate.xlsx"
