...
def simulate_failure_scenario_under_specific_nodes_targeted_attacks(global_json_path: str):
    ...
    output_json_path = 'cascading_failure_identification_under_big_nodes_attacks.json'
    ...
    file_paths['cascading_failure_identification_under_big_nodes_attacks'] = output_json_path
